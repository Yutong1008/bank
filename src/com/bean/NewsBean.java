...
public class NewsBean {
	...
	//add news
	public int addNews(String title,String fenlei,String content,String adder){
		String sql = "insert into fz_news (title,fenlei,content,addtime,adder,visit) " +
				"values ('"+title+"','"+fenlei+"','"+content+"','"+date+"','"+adder+"','0')";
		DBO dbo = new DBO();
		dbo.open();
		try{
	...
	//update news
	public int updateNews(int id,String title,String fenlei,String content,String adder){
		String sql = "update fz_news set title = '"+title+"',fenlei = '"+fenlei+"',content='"+content+"',addtime='"+date+"'," +
				"adder='"+adder+"' where id = '"+id+"' ";
		DBO dbo = new DBO();
		dbo.open();
		try{
			int i = dbo.executeUpdate(sql);
...
//	首页12条新闻
	public List getIndexNews12(){
		String sql = "select top 13 id,title,addtime from fz_news where  ifhide='1' order by id desc ";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
...
//	更新点击率
	...
	public List getNextNews(int id){
		String sql = "select top 1 id,title from fz_news where  ifhide='1' and id>'"+id+"' order by id asc";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
...
//	 上一条
	public List getFollowNews(int id){
		String sql = "select top 1 id,title from fz_news where  ifhide='1' and id<'"+id+"' order by id desc";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
