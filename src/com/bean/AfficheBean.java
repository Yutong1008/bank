...
//	增加投票
	public int addVote(String title,String ifhide ,String item1,String item2,String item3,String item4,String item5,String item6,
		...
		String sql = "insert into fz_vote ( title, ifhide , item1, item2, item3, item4,item5,item6,tick1, tick2 , tick3 , tick4,tick5,tick6,addtime ) " +
		...
		try{
			if(ifhide.equals("1")){
				dbo.executeUpdate("update  fz_vote set ifhide='0' ");
			}
			int flag = dbo.executeUpdate(sql);
				if(flag == 1)
					return Constant.SUCCESS;
	...
	public int updateVote(int id,String title,String ifhide ,String item1,String item2,String item3,String item4,String item5,String item6,
			String tick1,String tick2 ,String tick3 ,String tick4,String tick5,String tick6 ){
		String sql = "update  fz_vote set title='"+title+"', ifhide='"+ifhide+"' , item1='"+item1+"', item2='"+item2+"'," +
	...
	public int delVote(int id){
		String sql = "delete from fz_vote where id='"+id+"'";
		DBO dbo = new DBO();
		dbo.open();
		try{
			int flag = dbo.executeUpdate(sql);
	...
	public List getVote(int id){
		String sql = "select * from fz_vote where id='"+id+"'  ";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
...
//	查询所有投票
	public List getAllVote(){
		String sql = "select * from fz_vote order by id desc  ";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
...
//	查询前台显示投票
	public List getVote(){
		String sql = "select * from fz_vote where ifhide='1'  ";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
...
//	open.close vote
	public int hideSurvey(int id){
		String sql = "update fz_vote set ifhide='1' where id='"+id+"'";
		String sql2 = "update fz_vote set ifhide='0' where id='"+id+"'";
		String sql3 = "select ifhide from fz_vote where id='"+id+"'";
		DBO dbo = new DBO();
		dbo.open();
		try{
			rs = dbo.executeQuery(sql3);
	...
	public int addVote(int id,String item){
		String sql = "update fz_vote set "+item+"="+item+"+1  where id='"+id+"'";
		DBO dbo = new DBO();
		dbo.open();
		try{
			int flag = dbo.executeUpdate(sql);
	...
	public int addMemAff(String content,String type){
		String sql = "insert into fz_memaff(content,type,addtime) values('"+content+"','"+type+"','"+date+"')";
		DBO dbo = new DBO();
		dbo.open();
		try{
			int flag = dbo.executeUpdate(sql);
...
//	查询所有会员中心公告
	public List getAllMemAff(){
		String sql = "select * from fz_memaff order by id desc  ";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
	...
	public int delMemAff(int id){
		String sql = "delete from fz_memaff where id='"+id+"'";
		DBO dbo = new DBO();
		dbo.open();
		try{
			int flag = dbo.executeUpdate(sql);
...
//	查询所有会员中心公告 前台
	public List getAllMemAff(String type){
		String sql = "select content,addtime from fz_memaff where type='"+type+"' order by id desc  ";
		DBO dbo = new DBO();
		list = new ArrayList();
		dbo.open();
		try{
